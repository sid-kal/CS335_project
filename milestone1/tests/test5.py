...
def main() -> None:
    ...
    savings_acc = SavingsAccount(account_number="SA001", balance=1000, interest_rate=2.5)
    ...
    checking_acc = CheckingAccount(account_number="CA001", balance=2000, overdraft_limit=500)
